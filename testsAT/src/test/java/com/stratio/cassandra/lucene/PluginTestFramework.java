...
public abstract class PluginTestFramework {
    ...
    static class NestedSingleton implements BeforeAllCallback, ExtensionContext.Store.CloseableResource {
        ...
        public static final String pluginCassandraVersion = System.getProperty("plugin.version", "4.0.1-1.0.0");
        public static final String cassandraVersion = System.getProperty("cassandra.version", "4.0.1");
